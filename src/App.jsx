...
function EmailLogin({ onSubmit }) {
  ...
  return (
    <div style={{ display: "flex", gap: 8 }}>
      ...
      />
      <button onClick={() => onSubmit(email)} style={btn("primary")}>
        Log ind
      </button>
    </div>
  );
...
export default function App() {
  ...
  async function confirmCrop() {
    ...
    if (cropFor === "edit")
      setEditDraft((d) => ({ ...d, photoDataUrl: dataUrl }));
    if (cropFor === "cover") {
    ...
    <div style={{ minHeight: "100vh", background: "#0f1115", color: "white" }}>
      <div
        style={{
          ...
          margin: "0 auto",
          padding: 24,
          // 👇 ekstra luft ovenfor titel på iPhone (statusbar / notch)
      ...
      >
        ...
        <section style={{ marginTop: 16 }}>
          {beers.length === 0 ? (
            <div style={{ opacity: 0.7 }}>Ingen øl endnu – brug “Tilføj Øl” 🍺</div>
          ) : (
            <div
              style={{
                display: "grid",
                ...
                <article key={b.id} style={card({ padding: 0 })}>
                  <div style={{ display: "flex", flexWrap: "wrap" }}>
                    ...
                    <div style={{ flex: 1, minWidth: 200, padding: 12 }}>
                      ...
                      {/* 👇 kun værdier – ingen “Farve:” label */}
                      <div style={{ opacity: 0.9, fontSize: 16 }}>
                        {b.brewery || "—"} • {b.style || "—"} • {b.color || "—"}
                      </div>

                      {/* 👇 pris som ren værdi (vil du have “kr.”, tilføj +" kr.") */}
                      ...
                      >
                        ...
                        <button onClick={() => deleteBeer(b)} style={btn("danger-sm")}>
                          Slet
                        </button>
                      </div>
                    </div>
        ...
        >
          ...
          >
            ...
            <div style={{ marginTop: 12, display: "flex", gap: 8, justifyContent: "flex-end" }}>
              <button onClick={() => setAddOpen(false)} style={btn("ghost-sm")}>
                Annuller
              </button>
